...
export type { default as EazyImageInputProperties } from "./image-submit/image/EazyImageInputProperties";

export { EazyTextInput as default } from "./text/EazyTextInput";
